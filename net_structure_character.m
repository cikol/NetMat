function [character]=net_structure_character_new(Net,path_sets)
...
%% datu posmu skaits
[num_shared_links,num_of_links,link_disjointness,num_of_nodes]=shared_links_new(Net,path_sets);
